...
import com.example.fullproject.model.Task;
import com.example.fullproject.model.TaskPriority;
...
public interface Controller {
    ...
    MainMenuLeaderController LEADER_MAIN = new MainMenuLeaderController();
